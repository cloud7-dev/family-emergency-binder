...
- Record edit, drag-and-drop, bulk ZIP export, Argon2id, cloud sync, OCR, external audit, and repo rename are out of v0.6 scope.
...
- Record edit flow for structured fields / 구조화 필드 기록 수정 흐름
